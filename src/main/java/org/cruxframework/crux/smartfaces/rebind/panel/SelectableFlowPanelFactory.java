 ...
 *
 */
@DeclarativeFactory(library=Constants.LIBRARY_NAME, id="selectableFlowPanel", targetWidget=SelectableFlowPanel.class, 
					description="A Flow Panel that support select events.")
